...
Until now ``dashboard/tests/web/views/test_views.py``, ``test_xvb_views.py``, ``test_infra_views.py`` and
...
* ``dashboard/tests/web/views/test_prometheus.py`` and ``tests/web/test_node_location.py`` keep their own
