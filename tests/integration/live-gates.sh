...
# shellcheck source=tests/integration/live-upgrade-support.sh
source "$HERE/live-upgrade-support.sh"
# shellcheck source=tests/integration/live-state-support.sh
source "$HERE/live-state-support.sh"
# shellcheck source=tests/integration/live-xvb-support.sh
source "$HERE/live-xvb-support.sh"
