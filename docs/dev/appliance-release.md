...
- Reinstall pre-fill and failed-install recovery: confirm the migration notice names the removed
  1.x key without showing values, and that the returned form visibly keeps the safe fields.
